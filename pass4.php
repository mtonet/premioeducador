...
if ($action == 'save') {
	...
	elseif ($categoria == 'G') {
		...
		if ($_REQUEST['segmento-eic']=='EIC') {
		$segmento_ei = 1;
		}

		if ($_REQUEST['segmento-eip']=='EIP') {
		$segmento_ei = 2;
		}

		if ( ($_REQUEST['segmento-eic']=='EIC') && ($_REQUEST['segmento-eip']=='EIP') ) {
		$segmento_ei = 3;
		}
		...
		<div class="control-group gestor-group" <?php if ($e_gestor == false): ?>style="display: none"<?php endif; ?> >
          <label class="control-label" for="segmento-gestor-area">Segmento em que foi desenvolvido o trabalho (*)<br> <span class="subtexto">(Selecione uma ou mais opções)</span></label>
            <div class="controls" id="segmento-gestor-area">
                ...
                <input type="checkbox" id="input-segmento-gestor-eic" name="segmento-eic" value="EIC" <?php if ( ($DadosGestor['seg_edu_inf'] == 1) || ($DadosGestor['seg_edu_inf'] == 3)): ?> checked="checked" <?php endif; ?>> Educação Infantil: Creche
                </label>
                
                
<label class="checkbox inline">
                <input type="checkbox" id="input-segmento-gestor-eip" name="segmento-eip" value="EIP" <?php if ( ($DadosGestor['seg_edu_inf'] == 2) || ($DadosGestor['seg_edu_inf'] == 3) ): ?> checked="checked" <?php endif; ?>> Educação Infantil: Pré-escola
                </label>                
		...
		<div class="control-group professor-group" <?php if ($e_professor == false): ?>style="display: none"<?php endif; ?> >
            ...
            <div class="control-group" <?php if ($e_professor == false && $e_gestor == false): ?>style="display: none"<?php endif; ?> >
              ...
              <div class="controls">
				...
				<span class="box-obrigatorio" style="font-size:10px; color: red; display: none">Campo obrigatório.</span>
				<br /><span class="subtexto">Seu trabalho deve ter sido realizado no ano letivo de 2014 ou no 1º semestre de 2015. No entanto, para ser inscrito, o trabalho deve estar concluído e ter sido avaliado.</span>
              </div>
            </div>
