...
$urlVoz = "https://api.directcallsoft.com/voz/call";
...
// Gravar? se sim = "s" se não = "n"
$gravar = "n"; //Opcional o envio
...
$data = http_build_query(array('origem'=>$origem, 'destino'=>$destino, 'tipo'=>"texto" ,'gravar'=>$gravar, 'access_token'=>$access_token, 'texto'=>$SMS));
