            ...
            <div class="border">
                <table width="100%" border="0">
                  <tr>
                    ...
                    <td colspan="5"><?php echo utf8_encode($line['esc_nome']); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="5"><?php echo utf8_encode($line['esc_cargo']); ?></td>
                  </tr>
                </table>
			</div><!--Fim border-->
            ...
            <div class="border">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td>Atuação</td>
                    <td class="screen-only"><?php print_atuacao($line); ?></td>
                  </tr>
				  <tr>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><?php print_trabalho_titulo($line); ?></td>
                  </tr>
                  <tr>
