...
function htmlPaginacao($pagAt,$configPaginacao,$result){
	...
	if ($total_de_paginas > 0) 
		{
			...
			// link "anterior"  
			if($pagina_atual > 1) 
			    $link_de_navegacao .= "  <li><a href=\"?paginaAtual=$pagina_anterior&#lista\" style=\"color:#5a5a5a; text-decoration:none;\">«</a> </li>"; 
			...
			{ 
			    ...
			    if($i != $pagina_atual) 
			        $link_de_navegacao .= " <li><a href=\"?paginaAtual=$i&#lista\" style=\"color:#5a5a5a; text-decoration:none;\">$i</a></li> "; 
			    else
			...
			if($pagina_atual != $total_de_paginas) 
			    $link_de_navegacao .= " <li><a href=\"?paginaAtual=$pagina_posterior&#lista\" style=\"color:#5a5a5a; text-decoration:none;\" class=\"paginacao\">»</a></li>"; 
		}
