              ...
              <a href="ver-nao-finalizados.php" style="margin: 0 0 0 30px">Lista de não-finalizados</a>
					...
					?>
                      <tr>
                        ...
                        <td>
						<?php if ($line['ultimo_passo'] > 5): ?><a class="trabalho-download" data-id="<?php echo $line['id']; ?>" data-url="../upload/<?php echo htmlentities(urlencode($line['nome_arquivo'])); ?>">
                        		<i class="icon-download<?php if ($line['status'] == 1) echo " done"; ?>"></i></a>
						<?php endif; ?>
                        </td>
