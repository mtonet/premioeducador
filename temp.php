...
?>
            ...
            <ul id="txt-index">
              ...
              <li>Atente-se às instruções para a redação do seu trabalho: extensão do arquivo, fonte, peso do arquivo. Para facilitar use o formulário abaixo:<br>
Professores: <a href="http://inscricoespvc2014.com.br/upload/modelo_redacao_professores.doc">Clique aqui para fazer o download do formulário</a><br>
Gestores: <a href="http://inscricoespvc2014.com.br/upload/modelo_redacao_gestores.doc">Clique aqui para fazer o download do formulário</a></li>
