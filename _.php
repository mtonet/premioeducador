...
?>
            ...
            Leia atentamente as informações a seguir antes de iniciar o processo de inscrição:
            <ul id="txt-index">
            ...
            <li>Atente-se às instruções para a redação do seu trabalho: extensão do arquivo, fonte, peso do arquivo.</li>
            <li>A partir da próxima tela, o processo de inscrição será feito em 5 (cinco) etapas. No final, caso necessário, você poderá revisar cada etapa. Depois de finalizar a sua inscrição, você receberá um e-mail de confirmação de inscrição e seus dados 
    não poderão mais ser alterados.</li>
            <li>Anote e guarde seu login, sua senha e seu número de inscrição.</li>
			...
			<li>Para prosseguir com sua inscrição, clique no botão "Li e concordo com o regulamento".</li>
            </ul>
            <hr>
            
            <form class="form-horizontal" id="login-signup" style="display: none">
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="email" class="input-xlarge" id="input-email" name="email">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="password" class="input-xlarge" id="input-senha" name="senha">
                  </div>
                </div>
