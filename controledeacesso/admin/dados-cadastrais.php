...
$paginaLimite = isset($_REQUEST['limite']) ? $_REQUEST['limite'] : 10;
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="javascript:;"><i class="<?php if($cad['confirmado']==''||$cad['confirmado']=='0000-00-00 00:00:00'): ?>icon-remove<?php else: ?>icon-ok<?php endif; ?>"></i></a></td>
