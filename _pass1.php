          ...
          <fieldset>
            ...
            <div class="controls">
              <select id="select-como" name="fonte">
                ...
                <option value="2"  <?php  if ($DadosCad['fonte'] =="2")  echo "SELECTED "  ?>>Revista GESTÃO ESCOLAR</option>
                ...
                <option value="5"  <?php  if ($DadosCad['fonte'] =="5")  echo "SELECTED "  ?>>Outros sites</option>
                <option value="6"  <?php  if ($DadosCad['fonte'] =="6")  echo "SELECTED "  ?>>Rádio</option>
                <option value="7"  <?php  if ($DadosCad['fonte'] =="7")  echo "SELECTED "  ?>>E-mail marketing</option>
                <option value="8"  <?php  if ($DadosCad['fonte'] =="8")  echo "SELECTED "  ?>>Secretaria Municipal de Educação</option>
                <option value="9"  <?php  if ($DadosCad['fonte'] =="8")  echo "SELECTED "  ?>>Secretaria Estadual de Educação</option>
                <option value="10"  <?php  if ($DadosCad['fonte'] =="10")  echo "SELECTED "  ?>>Orkut</option>
                <option value="11"  <?php  if ($DadosCad['fonte'] =="11")  echo "SELECTED "  ?>>Facebook</option>
                <option value="12"  <?php  if ($DadosCad['fonte'] =="12")  echo "SELECTED "  ?>>Twitter</option>
                <option value="13"  <?php  if ($DadosCad['fonte'] =="13")  echo "SELECTED "  ?>>Outros. Qual?</option>
              </select>
			  <span class="box-obrigatorio" style="font-size:10px; color: red; display: none">Campo obrigatório.</span>
            </div>
          </div>
