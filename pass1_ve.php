...
if ($action == 'save') {
	...
	if ( ($endereco=="") ||($bairro=="") ||($cidade=="")||($estado=="")){
		...
		echo("<script>alert('É necessário preencher o Endereço, Bairro, Cidade e Estado')</script>");
...
?>
        ...
        <form class="form-horizontal" action="pass1_ve.php" method="POST" id="pass1-form">
          ...
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="input-xlarge" id="input-endereco1" maxlength="64" name="endereco" value="<?php echo utf8_encode($DadosCad['endereco']); ?>">
				<span class="box-obrigatorio" style="font-size:10px; color: red; display: none">Campo obrigatório.</span>
              </div>
            </div>
